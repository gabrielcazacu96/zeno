---
title: TypeScript
description: Shared TypeScript configurations with @zeno/typescript
icon: FileCode
status: to check
---

Zeno uses the `@zeno/typescript` package to share strict TypeScript configurations across all packages and apps.
...
| Package type | Config |
|-------------|--------|
| Next.js app | `@zeno/typescript/nextjs.json` |
| React library | `@zeno/typescript/react.json` |
| Non-React package | `@zeno/typescript/strictest.json` |
| Loose / legacy | `@zeno/typescript/strict.json` |

### Examples in the Repo

| Package | Config |
|---------|--------|
| `apps/docs` | `@zeno/typescript/nextjs.json` |
| `packages/ui` | `@zeno/typescript/react.json` |
| `packages/supabase` | `@zeno/typescript/strictest.json` |
| `packages/e2e` | `@zeno/typescript/strictest.json` |
...
```bash
pnpm turbo run types:check --filter @zeno/ui
```
