...
>(({ asChild = false, className, ...props }, reference) => {
...
>(({ asChild = false, className, showOnHover = false, ...props }, reference) => {
  const Comp = asChild ? Slot : "button"
...
>(({ className, showIcon = false, ...props }, reference) => {
...
const SidebarMenuSubItem = React.forwardRef<
  HTMLLIElement,
  React.ComponentProps<"li">
>(({ ...props }, reference) => <li ref={reference} {...props} />)
...
>(({ asChild = false, className, isActive, size = "md", ...props }, reference) => {
